<template>
  ...
  <div class="indicator-title q-my-xl full-width">
    <h4>Contraste de registros de fecha de adjudicación vs fecha actual medida en días</h4>
  </div>
  
  <div class="form-container">
    <ContrasteDeRegistrosInputs 
...
import ContrasteDeRegistrosInputs from './ContrasteDeRegistrosInputs.vue';
...
const indicatorDataModel = reactive(
  {
    contractingProceduresSelectedValue: contractingProcedures[0],
