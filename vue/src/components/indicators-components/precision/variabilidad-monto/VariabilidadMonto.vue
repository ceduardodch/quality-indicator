<template>
  ...
  <div class="indicator-title q-my-xl full-width">
    <h4>Variabilidad de monto corregido entre monto de adjudicación y monto corregido de adjudicación</h4>
  </div>
  
  <div class="form-container">
    <VariabilidadMontoInputs 
...
import VariabilidadMontoInputs from './VariabilidadMontoInputs.vue';
