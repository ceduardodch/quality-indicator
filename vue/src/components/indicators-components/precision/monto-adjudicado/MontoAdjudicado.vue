<template>
  ...
  <div class="indicator-title q-my-xl full-width">
    <h4>Box plot de monto adjudicado por tipo de procedimiento de contratación pública</h4>
  </div>
  
  <div class="form-container">
    <MontoAdjudicadoInputs 
...
import MontoAdjudicadoInputs from './MontoAdjudicadoInputs.vue';
...
const indicatorDataModel = reactive(
  {
    contractingProceduresSelectedValue: contractingProcedures[15],
    userDateRangeQuery: userDateRangeQuery
  }
)

watch(indicatorDataModel, () => {
  console.log('FROM THE THIRD INDICATOR', indicatorDataModel)
})
