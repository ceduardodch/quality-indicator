<template>
  ...
  <div class="indicator-title q-my-xl full-width">
    <h4>Box plot de monto licitado por tipo de procedimiento de contratación pública</h4>
  </div>
...
import MontoLicitadoInputs from './MontoLicitadoInputs.vue';
...
watch(indicatorDataModel, () => {
  console.log('FROM THE SECOND INDICATOR', indicatorDataModel)
})
