<template>
  ...
  <div class="indicator-title q-my-xl full-width">
    <h4>Numero de registros con datos de montos $0 y $0,5</h4>
  </div>
  
  <div class="form-container">
    <NumeroRegistrosInputs 
...
import NumeroRegistrosInputs from './NumeroRegistrosInputs.vue';
...
const indicatorDataModel = reactive(
  {
    faseProcedimientoContratacionSelectedValue: faseProcedimientoContratacion[1],
...
watch(indicatorDataModel, () => {
  console.log('FROM THE FIRST INDICATOR', indicatorDataModel)
})
