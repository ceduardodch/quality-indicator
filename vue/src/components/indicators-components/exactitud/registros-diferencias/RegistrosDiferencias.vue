<template>
  ...
  <div class="indicator-title q-my-xl full-width">
    <h4>Registros con diferencias entre el monto de adjudicación y monto corregido por tipo de procedimiento de contratación</h4>
  </div>
  
  <div class="form-container">
    <RegistrosDiferenciasInputs 
...
import RegistrosDiferenciasInputs from './RegistrosDiferenciasInputs.vue';
...
watch(indicatorDataModel, () => {
  console.log('FROM THE FOURTH INDICATOR', indicatorDataModel)
})
