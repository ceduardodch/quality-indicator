-- View: public.view_indicador8_data

-- DROP VIEW public.view_indicador8_data;

CREATE OR REPLACE VIEW public.view_indicador8_data
 AS
...
ALTER TABLE public.view_indicador8_data
    OWNER TO postgres;
